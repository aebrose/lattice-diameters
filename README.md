...
- `algorithm_general_dimension.py`: Code to compute the lattice diameter of any rational polytope given by inequalities with rational entries.
...
print("A lattice diameter for every lattice diameter direction:", ld_segs_dir)
```
...
from algorithm_general_dimension import lattice_diameter_ILP
